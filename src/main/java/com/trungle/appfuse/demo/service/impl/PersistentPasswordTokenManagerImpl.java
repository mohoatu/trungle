...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.trungle.appfuse.demo.service.impl.PasswordTokenManager#generateRecoveryToken(com.trungle.appfuse.demo.model.User)
     */
    @Override
    ...
    /**
     * @see com.trungle.appfuse.demo.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.trungle.appfuse.demo.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.trungle.appfuse.demo.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
